...
(custom-theme-set-faces
 ...
 '(zenburn-strong-1-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf" :weight bold))))
 '(zenburn-strong-2-face ((((class color) (min-colors 89)) (:foreground "#dfaf8f" :weight bold))))
 '(zenburn-warning-face ((((class color) (min-colors 89)) (:foreground "#e0cf9f" :weight bold :underline t))))
 '(zenburn-error-face ((((class color) (min-colors 89)) (:foreground "#bc8383" :weight bold :underline t))))
 '(cursor ((((class color) (min-colors 89)) (:foreground "#dcdccc"))))
 ...
 '(erc-prompt-face ((((class color) (min-colors 89)) (:foreground "#dfaf8f" :weight bold))))
 '(erc-timestamp-face ((((class color) (min-colors 89)) (:foreground "#8fb28f"))))
 '(erc-underline-face ((t (:underline t))))
 '(gnus-group-mail-1-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-mail-1-empty))))
 '(gnus-group-mail-1-empty-face ((((class color) (min-colors 89)) (:inherit gnus-group-news-1-empty))))
 '(gnus-group-mail-2-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-mail-2-empty))))
 '(gnus-group-mail-2-empty-face ((((class color) (min-colors 89)) (:inherit gnus-group-news-2-empty))))
 '(gnus-group-mail-3-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-mail-3-empty))))
 ...
 '(gnus-group-mail-low-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-mail-low-empty))))
 '(gnus-group-mail-low-empty-face ((((class color) (min-colors 89)) (:inherit gnus-group-news-low-empty))))
 '(gnus-group-news-1-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-news-1-empty))))
 '(gnus-group-news-2-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-news-2-empty))))
 '(gnus-group-news-3-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-news-3-empty))))
 '(gnus-group-news-4-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-news-4-empty))))
 '(gnus-group-news-5-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-news-5-empty))))
 '(gnus-group-news-6-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-news-6-empty))))
 '(gnus-group-news-low-face ((((class color) (min-colors 89)) (:bold t :inherit gnus-group-news-low-empty))))
 ...
 '(gnus-summary-cancelled-face ((((class color) (min-colors 89)) (:foreground "#dfaf8f"))))
 '(gnus-summary-high-ancient-face ((((class color) (min-colors 89)) (:foreground "#8cd0d3"))))
 '(gnus-summary-high-read-face ((((class color) (min-colors 89)) (:foreground "#7f9f7f" :weight bold))))
 '(gnus-summary-high-ticked-face ((((class color) (min-colors 89)) (:foreground "#dfaf8f" :weight bold))))
 '(gnus-summary-high-unread-face ((((class color) (min-colors 89)) (:foreground "#dcdccc" :weight bold))))
 '(gnus-summary-low-ancient-face ((((class color) (min-colors 89)) (:foreground "#8cd0d3"))))
 '(gnus-summary-low-read-face ((t (:foreground "#7f9f7f"))))
 '(gnus-summary-low-ticked-face ((((class color) (min-colors 89)) (:foreground "#dfaf8f" :weight bold))))
 '(gnus-summary-low-unread-face ((((class color) (min-colors 89)) (:foreground "#dcdccc"))))
 '(gnus-summary-normal-ancient-face ((((class color) (min-colors 89)) (:foreground "#8cd0d3"))))
 '(gnus-summary-normal-read-face ((((class color) (min-colors 89)) (:foreground "#7f9f7f"))))
 '(gnus-summary-normal-ticked-face ((((class color) (min-colors 89)) (:foreground "#dfaf8f" :weight bold))))
 '(gnus-summary-normal-unread-face ((((class color) (min-colors 89)) (:foreground "#dcdccc"))))
 '(gnus-summary-selected-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf" :weight bold))))
 '(gnus-cite-1-face ((((class color) (min-colors 89)) (:foreground "#8cd0d3"))))
 '(gnus-cite-10-face ((((class color) (min-colors 89)) (:foreground "#e0cf9f"))))
 '(gnus-cite-11-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf"))))
 '(gnus-cite-2-face ((((class color) (min-colors 89)) (:foreground "#7cb8bb"))))
 '(gnus-cite-3-face ((((class color) (min-colors 89)) (:foreground "#6ca0a3"))))
 '(gnus-cite-4-face ((((class color) (min-colors 89)) (:foreground "#9fc59f"))))
 '(gnus-cite-5-face ((((class color) (min-colors 89)) (:foreground "#8fb28f"))))
 '(gnus-cite-6-face ((((class color) (min-colors 89)) (:foreground "#7f9f7f"))))
 '(gnus-cite-7-face ((((class color) (min-colors 89)) (:foreground "#cc9393"))))
 '(gnus-cite-8-face ((((class color) (min-colors 89)) (:foreground "#bc8383"))))
 '(gnus-cite-9-face ((((class color) (min-colors 89)) (:foreground "#ac7373"))))
 '(gnus-group-news-1-empty-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf"))))
 '(gnus-group-news-2-empty-face ((((class color) (min-colors 89)) (:foreground "#afd8af"))))
 '(gnus-group-news-3-empty-face ((((class color) (min-colors 89)) (:foreground "#8fb28f"))))
 '(gnus-group-news-4-empty-face ((((class color) (min-colors 89)) (:foreground "#6ca0a3"))))
 '(gnus-group-news-5-empty-face ((((class color) (min-colors 89)) (:foreground "#5c888b"))))
 '(gnus-group-news-6-empty-face ((((class color) (min-colors 89)) (:foreground "#5f5f5f"))))
 '(gnus-group-news-low-empty-face ((((class color) (min-colors 89)) (:foreground "#5f5f5f"))))
 '(gnus-signature-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf"))))
 '(gnus-x-face ((((class color) (min-colors 89)) (:background "#dcdccc" :foreground "#3f3f3f"))))
 ...
 '(linum ((((class color) (min-colors 89)) (:foreground "#656555" :background "#2b2b2b"))))
 ...
 '(message-header-name-face ((((class color) (min-colors 89)) (:foreground "#8fb28f"))))
 '(message-header-other-face ((((class color) (min-colors 89)) (:foreground "#7f9f7f"))))
 '(message-header-to-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf" :weight bold))))
 '(message-header-from-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf" :weight bold))))
 '(message-header-cc-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf" :weight bold))))
 '(message-header-newsgroups-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf" :weight bold))))
 '(message-header-subject-face ((((class color) (min-colors 89)) (:foreground "#dfaf8f" :weight bold))))
 '(message-header-xheader-face ((((class color) (min-colors 89)) (:foreground "#7f9f7f"))))
 '(message-mml-face ((((class color) (min-colors 89)) (:foreground "#f0dfaf" :weight bold))))
